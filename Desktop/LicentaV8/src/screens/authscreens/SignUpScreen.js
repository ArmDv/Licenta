...
const SignUpScreen= ({navigation}) =>{                   
    ...
    try{
        await auth().createUserWithEmailAndPassword(email,password)   //  (1)
        console.log("USER ACCOUNT CREATED")
        }
        catch(error)
        {
            if(error.code === 'auth/email-already-in-use'){          //   (2)
            Alert.alert('That email address is already inuse')
  }
    if(error.code === 'auth/invalid-email'){                         //   (3)
      Alert.alert(
                        ...
                        <View style ={styles.view2}>
                               ...
                               <View style ={styles.view17}>
                                  <Button
                                     ...
                                     // onPressIn={()=>
                                      //navigation.navigate('DrawerContinut',{paramKey:username})}
                                   />
                               </View>
                        </View>
